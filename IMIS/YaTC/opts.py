def model_opts(parser):
    # data preprocessing
    parser.add_argument('--input_packets', default=5, type=int)
    parser.add_argument('--header_bytes', default=80, type=int)
    parser.add_argument('--payload_bytes', default=240, type=int)
    parser.add_argument('--row_bytes', default=40, type=int)
...
#20
    ...
    parser.add_argument('--finetune', default='./pretrained-model.pth',
